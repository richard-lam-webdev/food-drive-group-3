...
export default function CategoriesMagasinier() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-4">Gestion des Catégories (Magasinier)</h1>
      ...
      <ul className="space-y-2">
        {categories.map((category) => (
          <li
            key={category.id}
            className="p-2 border rounded flex items-center space-x-4"
          >
            <Image
